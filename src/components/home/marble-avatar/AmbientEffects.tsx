...
export function AmbientEffects({ scale = 1, intensity = 0.5, color = "#D4AF37" }) {
  ...
  useFrame((state) => {
    ...
    if (glowRef.current) {
      ...
      glowRef.current.material.opacity = intensity * 0.4 * glowPulse;
